...
//======================================================================================
//queryPreferences RichQuery for Obtaining Template Obj
//======================================================================================
...
func (dlt *TemplateMgmtChaincode) queryTemplatesWithPagination(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	var jsonResp string
	if len(args) != 3 {
		logger.Errorf("queryPreferencesWithPagination:Invalid number of arguments provided for transaction")
