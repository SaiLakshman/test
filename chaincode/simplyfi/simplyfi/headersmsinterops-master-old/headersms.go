...
var logger = shim.NewLogger("HEADER-CHAINCODE-INITIALIZED-1.0")
...
func (t *HeaderChainCode) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
	...
	default:
		logger.Errorf("##### || Received Unknown Function invocation || ##### : Available Function : rh , rbh , uhs, qh, hfh, sh, qhwp")
		return shim.Error("##### || Received Unknown Function invocation || ##### Available function : rh , rbh , uhs, qh, hfh, sh, qhwp")
	}
}
