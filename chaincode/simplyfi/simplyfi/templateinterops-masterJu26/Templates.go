...
HeaderTypeturn shim.Error("updateTemplateStatus : Getting certificate Details Error : " + string(err.Error()))
HeaderType
HeaderTypezations := certData.Issuer.Organization
HeaderTypee = Template.Creator
HeaderTypezationName = Organizations[0]
HeaderType
