...
var dltDomainNames = map [string]string {
    ...
    "tata.com"   : "TA",                     //TATA
	"jio.com"    : "JI",                     //JIO
	"org1"		 : "Org1",	//for testing local
	"org2"		 : "Org2", 	//for testing local
}
...
func (t *HeaderChainCode) registerBulkHeader(stub shim.ChaincodeStubInterface, args []string) sc.Response  {
	...
	for i := 0; i < len(args); i++ {
		...
		data.ObjType = "HeaderVoice"
		dpeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'us = "A"
		dpeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'tor= Organizations[0]
		dpeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'tedBy = Organizations[0]
		lpeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'fof("Header_ID is " + data.Header_ID)
		hpeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'ytes, err := json.Marshal(data)
		ipeer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}' nil {
		peer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'r.Errorf("registerBulkHeader : Marshalling Error : " + string(err.Error()))
		peer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'n shim.Error("registerBulkHeader : Marshalling Error : " + string(err.Error()))
		}peer chaincode invoke -o orderer-simplyfi-co-in:7050 -n headervoice -C telcocommon  -c '{"args":["rh","{\"hid\":\"QT041111111111111101\",\"peid\":\"A11111111101\",\"cname\":\"OLAPAY\",\"cli\":\"123456789\",\"ctgr\":\"8\",\"cts\":\"456789\",\"uts\":\"456787678\",\"htyp\":\"P\",\"cmode\":\"11\"}"]}'
		//Inserting DataBlock to BlockChain
		err = stub.PutState(data.Header_Name, headerAsBytes)
		if err != nil {
